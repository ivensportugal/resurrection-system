<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  <input type="radio" name="filter" value="name">Search by name<br>
  ...
  <input type="radio" name="filter" value="room">Search by room<br>
      ...
      <table>
        <tr>
          ...
          <td class='userinfo-columnn userinfo-right'><input name="findResident" type="submit" id="findResident" value="Find Resident"></td>
